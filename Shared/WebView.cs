...
public partial class WebView : View, IRenderedBy<WebViewRenderer>, FormField.IControl
{
    string url;
    string html;
    readonly string ResourceNamespace;
    readonly Assembly ResourceAssembly;

    public readonly AsyncEvent BrowserNavigated = new();
    public readonly AsyncEvent<NavigatingEventArgs> BrowserNavigating = new();
    public WebViewConfiguration WebViewConfiguration { get; } = new WebViewConfiguration();
    /// <summary>
    /// Parameters are Error code and error text.
    /// </summary>
    public readonly AsyncEvent<string> LoadingError = new();
    public readonly AsyncEvent LoadFinished = new();
    public readonly AsyncEvent SourceChanged = new();
