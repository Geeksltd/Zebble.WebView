...
partial class WebView
{
    ...
    {
        string Html;
        readonly HtmlDocument Doc = new();
        readonly List<KeyValuePair<string, string>> ExistingInlineScriptReplacements = [];
        readonly Dictionary<string, string> CodeReplacements = [];
        ...
        byte[] ReadResourceBytes(string url)
        {
            ...
            if (url.Contains(":")) return []; // External URL

            if (!MergeExternalResources) return [];
